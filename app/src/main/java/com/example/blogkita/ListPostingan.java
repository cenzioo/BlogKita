...
public class ListPostingan extends RecyclerView.Adapter<ListPostingan.ListViewHolder> {
    ...
    public ListPostingan(List<ModelPostingan> postingan, Context context) {
